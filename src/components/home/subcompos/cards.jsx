...
const UserCards = ({ userData }) => {
    ...
    return (
        <main className='mt-[60px] overflow-auto px-2 min-h-[calc(100vh-60px)] relative '>
            {selectedCard ? <DetailedCard fetchCards={fetchCards} card_number={selectedCard.card_number} onClose={handleCloseModal} userUID={userData.userUID} cvv={selectedCard.cvv} /> : (isProcessing ? (
